package com.sg.rl.common.entity.base;
...
public class R<T> {
    ...
    public static <E> R<E> fail(BussinessException exception) {
        if (exception == null) {
    ...
    public static <E> R<E> validFail(BussinessException exceptionCode) {
        return new R<>(exceptionCode.getCode(), null,
                (exceptionCode.getErrorMessage() == null || exceptionCode.getErrorMessage().isEmpty()) ? DEF_ERROR_MESSAGE : exceptionCode.getErrorMessage());
    }
