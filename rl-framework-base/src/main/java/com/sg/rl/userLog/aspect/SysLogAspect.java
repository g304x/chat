package com.sg.rl.userLog.aspect;
...
import com.sg.rl.userLog.event.SysLogEvent;
import com.sg.rl.userLog.util.LogUtil;
...
public class SysLogAspect {
     ...
     */
    @Pointcut("@annotation(com.sg.rl.userLog.annotation.SysLog)")
    ...
    public void recordLog(JoinPoint joinPoint) throws Throwable {
        tryCatch((val) -> {
            ...
            if(null != parameterNames
                ...
                Map<String,Object> parmValMap = new HashMap<>();
                for (int index = 0;index < parameterNames.length;index++) {
                    parmValMap.put(parameterNames[index],args[index]);
                }
                log.info("解析出来参数键值对是 {}",JSONObject.toJSONString(parmValMap));
            }
